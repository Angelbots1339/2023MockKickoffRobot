...
//   public static Command FollowTrajectoryWithEvents(PathPlannerTrajectory traj, Boolean useVision, Swerve swerve /*Pass in other subsystems*/) {
//     return new FollowPathWithEvents(new SwerveFollowTrajectory(traj, swerve, useVision), traj.getMarkers(),
//         AutoEventMarkers.getMap(/*Pass in subsystems*/));
//   }
